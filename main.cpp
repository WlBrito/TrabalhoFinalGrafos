...
// Função para ler arestas do arquivo                                TA ERRANDO AQUI KARLA
...
// Implementação do algoritmo de Dijkstra                         TA FALTANDO ATUALIZAR NOVO CUSTO, NEM GPT E NEM CRISTO AQui
